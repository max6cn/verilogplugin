...
public class VerilogModuleBodyImpl extends ASTWrapperPsiElement implements VerilogModuleBody {
  ...
  public VerilogModuleBodyImpl(ASTNode node) {
    super(node);
  }

  public void accept(@NotNull PsiElementVisitor visitor) {
    if (visitor instanceof VerilogVisitor) ((VerilogVisitor)visitor).visitModuleBody(this);
    else super.accept(visitor);
  }

  @Override
  @NotNull
  public VerilogNameOfModule getNameOfModule() {
    return findNotNullChildByClass(VerilogNameOfModule.class);
  }
