...
public class VerilogLvalueImpl extends ASTWrapperPsiElement implements VerilogLvalue {

  public VerilogLvalueImpl(@NotNull ASTNode node) {
    super(node);
  }
  ...
  @Override
  @Nullable
  public VerilogLvalueConcatList getLvalueConcatList() {
    return findChildByClass(VerilogLvalueConcatList.class);
  }
