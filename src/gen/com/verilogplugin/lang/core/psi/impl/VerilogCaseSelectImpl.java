...
public class VerilogCaseSelectImpl extends ASTWrapperPsiElement implements VerilogCaseSelect {

  public VerilogCaseSelectImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull VerilogVisitor visitor) {
    visitor.visitCaseSelect(this);
  }
