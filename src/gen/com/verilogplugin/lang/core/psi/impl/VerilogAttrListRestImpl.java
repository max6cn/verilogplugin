...
public class VerilogAttrListRestImpl extends ASTWrapperPsiElement implements VerilogAttrListRest {

  public VerilogAttrListRestImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull VerilogVisitor visitor) {
    visitor.visitAttrListRest(this);
  }
  ...
  @Override
  @Nullable
  public VerilogAttrList getAttrList() {
    return findChildByClass(VerilogAttrList.class);
  }
