...
public class VerilogRangeOrIntegerImpl extends ASTWrapperPsiElement implements VerilogRangeOrInteger {

  public VerilogRangeOrIntegerImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull VerilogVisitor visitor) {
    visitor.visitRangeOrInteger(this);
  }
