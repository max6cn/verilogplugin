...
public class VerilogCaseItemImpl extends ASTWrapperPsiElement implements VerilogCaseItem {

  public VerilogCaseItemImpl(@NotNull ASTNode node) {
    super(node);
  }
  ...
  @Override
  @NotNull
  public VerilogBehavioralStmtOpt getBehavioralStmtOpt() {
    return findNotNullChildByClass(VerilogBehavioralStmtOpt.class);
  }
