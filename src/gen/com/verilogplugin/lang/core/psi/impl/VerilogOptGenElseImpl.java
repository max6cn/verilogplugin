...
public class VerilogOptGenElseImpl extends ASTWrapperPsiElement implements VerilogOptGenElse {

  public VerilogOptGenElseImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull VerilogVisitor visitor) {
    visitor.visitOptGenElse(this);
  }
  ...
  public VerilogGenStmtOrNull getGenStmtOrNull() {
    return findChildByClass(VerilogGenStmtOrNull.class);
  }
