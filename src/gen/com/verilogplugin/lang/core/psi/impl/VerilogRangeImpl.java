...
public class VerilogRangeImpl extends ASTWrapperPsiElement implements VerilogRange {

  public VerilogRangeImpl(@NotNull ASTNode node) {
    super(node);
  }
  ...
  @Override
  @Nullable
  public VerilogNonOptRange getNonOptRange() {
    return findChildByClass(VerilogNonOptRange.class);
  }
