...
public class VerilogWireNameAndOptAssignImpl extends ASTWrapperPsiElement implements VerilogWireNameAndOptAssign {

  public VerilogWireNameAndOptAssignImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull VerilogVisitor visitor) {
    visitor.visitWireNameAndOptAssign(this);
  }
  ...
  @Override
  @NotNull
  public VerilogWireName getWireName() {
    return findNotNullChildByClass(VerilogWireName.class);
  }
