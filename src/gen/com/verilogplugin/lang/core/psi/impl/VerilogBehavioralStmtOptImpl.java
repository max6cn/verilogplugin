...
public class VerilogBehavioralStmtOptImpl extends ASTWrapperPsiElement implements VerilogBehavioralStmtOpt {

  public VerilogBehavioralStmtOptImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull VerilogVisitor visitor) {
    visitor.visitBehavioralStmtOpt(this);
  }
