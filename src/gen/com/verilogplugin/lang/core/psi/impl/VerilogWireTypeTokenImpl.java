...
public class VerilogWireTypeTokenImpl extends ASTWrapperPsiElement implements VerilogWireTypeToken {

  public VerilogWireTypeTokenImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull VerilogVisitor visitor) {
    visitor.visitWireTypeToken(this);
  }
