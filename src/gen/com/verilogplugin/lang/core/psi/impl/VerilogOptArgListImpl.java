...
public class VerilogOptArgListImpl extends ASTWrapperPsiElement implements VerilogOptArgList {

  public VerilogOptArgListImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull VerilogVisitor visitor) {
    visitor.visitOptArgList(this);
  }
