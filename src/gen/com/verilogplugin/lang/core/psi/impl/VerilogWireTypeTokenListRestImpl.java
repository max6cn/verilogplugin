...
public class VerilogWireTypeTokenListRestImpl extends ASTWrapperPsiElement implements VerilogWireTypeTokenListRest {

  public VerilogWireTypeTokenListRestImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull VerilogVisitor visitor) {
    visitor.visitWireTypeTokenListRest(this);
  }
