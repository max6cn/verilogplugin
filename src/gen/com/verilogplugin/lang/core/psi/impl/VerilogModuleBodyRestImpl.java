...
public class VerilogModuleBodyRestImpl extends ASTWrapperPsiElement implements VerilogModuleBodyRest {

  public VerilogModuleBodyRestImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull VerilogVisitor visitor) {
    visitor.visitModuleBodyRest(this);
  }
  ...
  public VerilogModuleBodyRest getModuleBodyRest() {
    return findChildByClass(VerilogModuleBodyRest.class);
  }
