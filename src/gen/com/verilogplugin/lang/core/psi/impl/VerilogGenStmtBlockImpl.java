...
public class VerilogGenStmtBlockImpl extends ASTWrapperPsiElement implements VerilogGenStmtBlock {

  public VerilogGenStmtBlockImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull VerilogVisitor visitor) {
    visitor.visitGenStmtBlock(this);
  }
  ...
  public VerilogGenStmt getGenStmt() {
    return findNotNullChildByClass(VerilogGenStmt.class);
  }
