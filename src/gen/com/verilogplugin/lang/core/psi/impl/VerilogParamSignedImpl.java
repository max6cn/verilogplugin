...
public class VerilogParamSignedImpl extends ASTWrapperPsiElement implements VerilogParamSigned {

  public VerilogParamSignedImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull VerilogVisitor visitor) {
    visitor.visitParamSigned(this);
  }
