...
public class VerilogGenCaseBodyImpl extends ASTWrapperPsiElement implements VerilogGenCaseBody {

  public VerilogGenCaseBodyImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull VerilogVisitor visitor) {
    visitor.visitGenCaseBody(this);
  }
