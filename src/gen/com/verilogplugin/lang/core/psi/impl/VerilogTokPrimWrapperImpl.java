...
public class VerilogTokPrimWrapperImpl extends ASTWrapperPsiElement implements VerilogTokPrimWrapper {

  public VerilogTokPrimWrapperImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull VerilogVisitor visitor) {
    visitor.visitTokPrimWrapper(this);
  }
  ...
  @Override
  @Nullable
  public PsiElement getTokPrimitive() {
    return findChildByType(TOK_PRIMITIVE);
  }
