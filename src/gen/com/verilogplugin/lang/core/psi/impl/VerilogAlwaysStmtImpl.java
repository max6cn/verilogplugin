...
public class VerilogAlwaysStmtImpl extends ASTWrapperPsiElement implements VerilogAlwaysStmt {

  public VerilogAlwaysStmtImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull VerilogVisitor visitor) {
    visitor.visitAlwaysStmt(this);
  }
  ...
  @Override
  @Nullable
  public VerilogAlwaysCond getAlwaysCond() {
    return findChildByClass(VerilogAlwaysCond.class);
  }
  ...
  public VerilogBehavioralStmt getBehavioralStmt() {
    return findNotNullChildByClass(VerilogBehavioralStmt.class);
  }
