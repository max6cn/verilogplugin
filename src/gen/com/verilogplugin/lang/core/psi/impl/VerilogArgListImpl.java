...
public class VerilogArgListImpl extends ASTWrapperPsiElement implements VerilogArgList {

  public VerilogArgListImpl(@NotNull ASTNode node) {
    super(node);
  }
  ...
  @Override
  @Nullable
  public VerilogArgList2 getArgList2() {
    return findChildByClass(VerilogArgList2.class);
  }
