...
public class VerilogWireNameListImpl extends ASTWrapperPsiElement implements VerilogWireNameList {

  public VerilogWireNameListImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull VerilogVisitor visitor) {
    visitor.visitWireNameList(this);
  }
  ...
  @Override
  @NotNull
  public VerilogWireNameAndOptAssign getWireNameAndOptAssign() {
    return findNotNullChildByClass(VerilogWireNameAndOptAssign.class);
  }
