...
public class VerilogModuleArgOptAssignmentImpl extends ASTWrapperPsiElement implements VerilogModuleArgOptAssignment {

  public VerilogModuleArgOptAssignmentImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull VerilogVisitor visitor) {
    visitor.visitModuleArgOptAssignment(this);
  }
