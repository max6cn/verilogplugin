...
public class VerilogSingleCellImpl extends ASTWrapperPsiElement implements VerilogSingleCell {

  public VerilogSingleCellImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull VerilogVisitor visitor) {
    visitor.visitSingleCell(this);
  }
  ...
  public VerilogCellPortList getCellPortList() {
    return findNotNullChildByClass(VerilogCellPortList.class);
  }
