...
public class VerilogGenStmtOrNullImpl extends ASTWrapperPsiElement implements VerilogGenStmtOrNull {

  public VerilogGenStmtOrNullImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull VerilogVisitor visitor) {
    visitor.visitGenStmtOrNull(this);
  }
