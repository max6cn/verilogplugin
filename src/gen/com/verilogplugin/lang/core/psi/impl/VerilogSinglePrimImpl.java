...
public class VerilogSinglePrimImpl extends ASTWrapperPsiElement implements VerilogSinglePrim {

  public VerilogSinglePrimImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull VerilogVisitor visitor) {
    visitor.visitSinglePrim(this);
  }
  ...
  @Override
  @Nullable
  public VerilogSingleCell getSingleCell() {
    return findChildByClass(VerilogSingleCell.class);
  }
