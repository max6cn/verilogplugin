...
public class VerilogAssert_Impl extends ASTWrapperPsiElement implements VerilogAssert_ {

  public VerilogAssert_Impl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull VerilogVisitor visitor) {
    visitor.visitAssert_(this);
  }
