...
public class VerilogOptSignedImpl extends ASTWrapperPsiElement implements VerilogOptSigned {

  public VerilogOptSignedImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull VerilogVisitor visitor) {
    visitor.visitOptSigned(this);
  }
