...
public class VerilogParamIntegerImpl extends ASTWrapperPsiElement implements VerilogParamInteger {

  public VerilogParamIntegerImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull VerilogVisitor visitor) {
    visitor.visitParamInteger(this);
  }
