...
public class VerilogSimpleBehavioralStmtImpl extends ASTWrapperPsiElement implements VerilogSimpleBehavioralStmt {

  public VerilogSimpleBehavioralStmtImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull VerilogVisitor visitor) {
    visitor.visitSimpleBehavioralStmt(this);
  }
  ...
  @Override
  @NotNull
  public VerilogLvalue getLvalue() {
    return findNotNullChildByClass(VerilogLvalue.class);
  }
