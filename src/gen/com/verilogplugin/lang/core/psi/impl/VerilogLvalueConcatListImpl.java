...
public class VerilogLvalueConcatListImpl extends ASTWrapperPsiElement implements VerilogLvalueConcatList {

  public VerilogLvalueConcatListImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull VerilogVisitor visitor) {
    visitor.visitLvalueConcatList(this);
  }
