...
public class VerilogCellListImpl extends ASTWrapperPsiElement implements VerilogCellList {

  public VerilogCellListImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull VerilogVisitor visitor) {
    visitor.visitCellList(this);
  }
  ...
  public VerilogSingleCell getSingleCell() {
    return findNotNullChildByClass(VerilogSingleCell.class);
  }
