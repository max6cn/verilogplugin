...
public class VerilogCaseExprListImpl extends ASTWrapperPsiElement implements VerilogCaseExprList {

  public VerilogCaseExprListImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull VerilogVisitor visitor) {
    visitor.visitCaseExprList(this);
  }
  ...
  @Override
  @Nullable
  public VerilogCaseExprList getCaseExprList() {
    return findChildByClass(VerilogCaseExprList.class);
  }
