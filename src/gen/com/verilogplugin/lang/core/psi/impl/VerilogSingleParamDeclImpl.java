...
public class VerilogSingleParamDeclImpl extends ASTWrapperPsiElement implements VerilogSingleParamDecl {

  public VerilogSingleParamDeclImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull VerilogVisitor visitor) {
    visitor.visitSingleParamDecl(this);
  }
