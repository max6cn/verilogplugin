...
public class VerilogAttrImpl extends ASTWrapperPsiElement implements VerilogAttr {

  public VerilogAttrImpl(@NotNull ASTNode node) {
    super(node);
  }
  ...
  @Override
  @NotNull
  public List<VerilogAttrOpt> getAttrOptList() {
    return PsiTreeUtil.getChildrenOfTypeAsList(this, VerilogAttrOpt.class);
  }
