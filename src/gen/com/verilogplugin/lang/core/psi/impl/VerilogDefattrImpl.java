...
public class VerilogDefattrImpl extends ASTWrapperPsiElement implements VerilogDefattr {

  public VerilogDefattrImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull VerilogVisitor visitor) {
    visitor.visitDefattr(this);
  }
  ...
  @Override
  @NotNull
  public VerilogOptAttrList getOptAttrList() {
    return findNotNullChildByClass(VerilogOptAttrList.class);
  }
