...
public class VerilogAlwaysCondImpl extends ASTWrapperPsiElement implements VerilogAlwaysCond {

  public VerilogAlwaysCondImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull VerilogVisitor visitor) {
    visitor.visitAlwaysCond(this);
  }
