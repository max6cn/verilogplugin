...
public class VerilogLocalparamDeclImpl extends ASTWrapperPsiElement implements VerilogLocalparamDecl {

  public VerilogLocalparamDeclImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull VerilogVisitor visitor) {
    visitor.visitLocalparamDecl(this);
  }
