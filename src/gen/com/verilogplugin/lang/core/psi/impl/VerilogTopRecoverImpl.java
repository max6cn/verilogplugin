...
public class VerilogTopRecoverImpl extends ASTWrapperPsiElement implements VerilogTopRecover {

  public VerilogTopRecoverImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull VerilogVisitor visitor) {
    visitor.visitTopRecover(this);
  }
