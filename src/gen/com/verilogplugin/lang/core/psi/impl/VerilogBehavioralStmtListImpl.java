...
public class VerilogBehavioralStmtListImpl extends ASTWrapperPsiElement implements VerilogBehavioralStmtList {

  public VerilogBehavioralStmtListImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull VerilogVisitor visitor) {
    visitor.visitBehavioralStmtList(this);
  }
