...
public class VerilogAlwaysEventImpl extends ASTWrapperPsiElement implements VerilogAlwaysEvent {

  public VerilogAlwaysEventImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull VerilogVisitor visitor) {
    visitor.visitAlwaysEvent(this);
  }
