...
public class VerilogOptionalElseImpl extends ASTWrapperPsiElement implements VerilogOptionalElse {

  public VerilogOptionalElseImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull VerilogVisitor visitor) {
    visitor.visitOptionalElse(this);
  }
