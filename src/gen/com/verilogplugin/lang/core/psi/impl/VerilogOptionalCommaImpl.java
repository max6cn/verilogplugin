...
public class VerilogOptionalCommaImpl extends ASTWrapperPsiElement implements VerilogOptionalComma {

  public VerilogOptionalCommaImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull VerilogVisitor visitor) {
    visitor.visitOptionalComma(this);
  }
